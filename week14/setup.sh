...
sudo cat /etc/postgresql/13/main/pg_hba.conf >> /tmp/pg
sudo cp /etc/postgresql/13/main/pg_hba.conf /etc/postgresql/13/main/pg_hba.conf.DIST
sudo mv /tmp/pg /etc/postgresql/13/main/pg_hba.conf
